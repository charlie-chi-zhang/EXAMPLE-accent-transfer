...
xdata = np.load("kaggle_data_brother_target_smth.npy")

ydata = np.load("kaggle_labels_brother_target_smth.npy")
...
n_hidden_1 = 100
learning_rate = float(sys.argv[2]) # learning rate 0.0001
...
training_epochs = int(sys.argv[3]) # epochs
display_step = 50
batch_size = 16
...
with tf.Session() as sess:
    ...
    saver.restore(sess, 'models/pauls_rec_e1000_lr0001_100_100_smth_itself/checkpoints.ckpt')
    ...
    save_path = saver.save(sess,directory+'/checkpoints.ckpt')
